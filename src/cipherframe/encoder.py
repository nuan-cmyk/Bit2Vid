...
from cipherframe.config import DEFAULT_PBKDF2_ITERATIONS, VideoSettings
from cipherframe.crypto import encrypt_payload
from cipherframe.ecc import ReedSolomonLayer
from cipherframe.ffmpeg import finish_process, start_encoder
from cipherframe.transport import bits_to_frames, bytes_to_bits, build_transport_header
...
class VideoEncoder:
    ...
    def encode_file(self, input_path: Path, output_path: Path, password: str) -> None:
        ...
        process = start_encoder(output_path, self.settings)
